...
public final class NifflerCurrencyServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "guru.qa.grpc.niffler.NifflerCurrencyService";
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getAllCurrencies(com.google.protobuf.Empty request,
    ...
    /**
     */
    default void calculateRate(guru.qa.grpc.niffler.grpc.CalculateRequest request,
  ...
  /**
   * Base class for the server implementation of the service NifflerCurrencyService.
   */
  public static abstract class NifflerCurrencyServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return NifflerCurrencyServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service NifflerCurrencyService.
   */
  public static final class NifflerCurrencyServiceStub
      extends io.grpc.stub.AbstractAsyncStub<NifflerCurrencyServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service NifflerCurrencyService.
   */
  public static final class NifflerCurrencyServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<NifflerCurrencyServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service NifflerCurrencyService.
   */
  public static final class NifflerCurrencyServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<NifflerCurrencyServiceFutureStub> {
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              guru.qa.grpc.niffler.grpc.CurrencyResponse>(
                service, METHODID_GET_ALL_CURRENCIES)))
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              guru.qa.grpc.niffler.grpc.CalculateResponse>(
                service, METHODID_CALCULATE_RATE)))
        .build();
  }
  ...
  private static final class NifflerCurrencyServiceMethodDescriptorSupplier
    ...
    NifflerCurrencyServiceMethodDescriptorSupplier(java.lang.String methodName) {
